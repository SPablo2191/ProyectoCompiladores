...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','prueba.py',50),
  ('statement -> expression','statement',1,'p_statement_expr','prueba.py',54),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','prueba.py',58),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','prueba.py',59),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','prueba.py',60),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','prueba.py',61),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','prueba.py',68),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','prueba.py',72),
  ('expression -> NUMBER','expression',1,'p_expression_number','prueba.py',76),
  ('expression -> NAME','expression',1,'p_expression_name','prueba.py',80),
]
